...
const SliderArrowButton = ({ direction, onClick }) => (
  <button
    onClick={onClick}
    className={
      direction === "forward" ? "slider-arrow-next" : "slider-arrow-prev"
    }
  >
    {direction === "forward" ? (
    ...
    <Slider {...sliderSettings} className="full-width-slider">
      {slides.map(slide => (
        <div className="slide-container">
          <div className="slide">
            <div
              className="slide-background-desktop"
              style={{
                backgroundImage: `url(${slide.desktopBackgroundImage})`,
              }}
            />
            <div
              className="slide-background-mobile"
              style={{ backgroundImage: `url(${slide.mobileBackgroundImage})` }}
            />
