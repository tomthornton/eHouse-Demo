  ...
  return (
    <section className="featured-boxes full-width-container">
      <div className="container">
        {boxes.map((box, index) => (
          <div className="featured-box-wrapper" key={index}>
            <div className="featured-box">
              <div
                className="background-image-desktop"
                style={{
                  backgroundImage: `url(${box.desktopBackgroundImage})`,
                }}
              />
              <div
                className="background-image-mobile"
                style={{ backgroundImage: `url(${box.mobileBackgroundImage})` }}
              />
              <div className="featured-box-content">
                ...
                <div className="featured-box-links-container">
                  {box.links.map((link, i) => (
                    <div className="featured-box-link" key={i}>
                      {link}
                    </div>
                  ))}
                </div>
