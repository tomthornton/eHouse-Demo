            ...
            <div className='container'>
                <div className='text-box'>
                    <div className='text-box-content'>
                        ...
                        <h3 className='text-box-subtitle'>Everything you need for your summer get away!</h3>
                        <button className='text-box-button'>Shop Summer Essentials</button>
                    </div>
                </div>
                <div className='text-image-banner-background-desktop' style={{backgroundImage: `url(${VacayThisWayDesktop})`}}/>
                <div className='text-image-banner-background-mobile' style={{backgroundImage: `url(${VacayThisWayMobile})`}}/>
            </div>
        </section>
    )
}
